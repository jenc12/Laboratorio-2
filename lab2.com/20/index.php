    ...
    <thead>
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <div class="progress">
                        <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated" role="progressbar" style="width: <?php echo $ale?>%;" aria-valuenow="<?php echo $ale?>" aria-valuemin="0" aria-valuemax="100"><?php echo $ale?>%</div>
                        </div>
                    </td>
                    <?php?>
                </tr>
